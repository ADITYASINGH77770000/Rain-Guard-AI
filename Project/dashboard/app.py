...
# # ============================================================
# # TAB 2 — CRITICAL INFRASTRUCTURE (MAIN CHANGE HERE)
# # ============================================================
# with tab2:
#     st.subheader("Critical Infrastructure Risk — Zone-wise Classification")
#     i1, i2, i3, i4 = st.columns(4)
...
#     # ======== MAIN CHANGE: REMOVED SUCCESS/ERROR MESSAGES ========
#     if alert_decision == 1:
#         st.error("SEND ALERT — Immediate Response Required")
#         if st.button("CONFIRM AND SEND ALERT", type="primary"):
#             msg_text = (f"FLOOD ALERT - {risk_level} RISK\nRisk: {risk_prob:.1%}\n"
...
#                         f"Critical assets at risk: {len(red_infra)}\nAction: Immediate evacuation")
#             if notify_enabled and notify_method == "Telegram" and tg_token and tg_chat_id:
#                 send_telegram_alert(tg_token, tg_chat_id, msg_text)
#             elif notify_enabled and notify_method == "Email (SMTP)" and from_em and em_pass and to_em:
#                 send_email_alert(to_em, f"FLOOD ALERT - {risk_level}", msg_text, smtp_srv, smtp_port, from_em, em_pass)
#             else:
#                 st.warning("Enable notifications in sidebar to send alerts.")
#     else:
#         st.success("NO ALERT — Continue Monitoring")
...
# # Paste your absolute logo path here if needed, for example:
# # CUSTOM_LOGO_PATH = r"D:\Riverthon\dashboard\assets\rainguard_logo.png"
# CUSTOM_LOGO_PATH = r"D:\Riverthon\dashboard\assets\RainGuard.png"
...
#     else:
#         st.markdown(
#             "<h1 style='text-align:center;margin:0;color:#0B3A75;letter-spacing:0.4px;'>RainGuard</h1>",
#             unsafe_allow_html=True,
#         )
...
#     else:
#         st.sidebar.markdown(
#             "<p style='text-align:center;font-weight:700;color:#0B3A75;margin:0'>RainGuard</p>",
#             unsafe_allow_html=True,
#         )
#     st.sidebar.markdown("<div class='sidebar-sep'></div>", unsafe_allow_html=True)
...
#         return None
#     try:
#         # QuoaMean API (QWeather-compatible endpoint).
#         url = f"https://devapi.qweather.com/v7/weather/now?location={lon},{lat}&key={api_key}"
#         resp = requests.get(url, timeout=20)
#         resp.raise_for_status()
#         payload = resp.json()
...
#         "Select API",
#         ["OpenStreetMap", "WeatherAPI", "QuoaMean API"],
#         index=0,
#     )
#     selected_api_key = ""
#     if selected_api in ("WeatherAPI", "QuoaMean API"):
...
#     with auto_col1:
#         st.markdown(f"""
#         <div style="background:{flood_bg};color:#0F172A;border-left:6px solid {flood_border};padding:16px;border-radius:8px">
...
#     with auto_col2:
#         st.markdown(f"""
#         <div style="background:#93C5FD;color:#0F172A;border-left:6px solid #1D4ED8;padding:16px;border-radius:8px">
...
#     st.markdown(f"""
#     <div style="background:#C4B5FD;color:#0F172A;border-left:6px solid #6A1B9A;padding:16px;border-radius:8px;margin-top:12px">
